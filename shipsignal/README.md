...
- `config.py` — loads repo-local `.shipsignal.toml` defaults (extra AI aliases, squash, fail-under, module excludes, badge label). Never raises — unknown keys and wrong types degrade to a warning + built-in default.
